...
public class Panel extends JPanel {
    ...
    protected float opacity = 1f; // 0f - transparent, 1f - opaque
    ...
    public Panel(
        ...
        this.cornerRadius = 12; // default rounded corners
    ...
    public void paintComponent(Graphics g) {
        ...
        for (int i = 0; i < shadowSize; i++) {
            ...
            g2d.setColor(new Color(0, 0, 0, Math.min(200, (int) (a * 255))));
            g2d.fillRoundRect(i + 4, i + 4, width - (i), height - (i), cornerRadius, cornerRadius);
        }
        ...
        if (backgroundColor != null) {
            ...
            Color c2 = backgroundColor.brighter();
